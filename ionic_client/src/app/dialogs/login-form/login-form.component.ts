...
export class LoginFormComponent implements OnInit, OnDestroy {
  ...
  public constructor(private readonly formBuilder: FormBuilder, private readonly modalController: ModalController, private readonly loginService: LoginService, private readonly userApiService: UserApiService) {
  }
  ...
  public async onSubmit(): Promise<void> {
    ...
    try {
      ...
      currentUser = await this.userApiService.getCurrentUser();
    } catch (e) {
    ...
    await Setting.set('userId', currentUser.id);
