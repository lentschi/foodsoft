...
ActiveRecord::Schema.define(version: 2021_12_27_143250) do
  ...
  create_table "order_repetition_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.date "starts_at"
    t.integer "frequency"
  ...
  create_table "suppliers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "order_repetition_setting_id"
    t.index ["name"], name: "index_suppliers_on_name", unique: true
    t.index ["order_repetition_setting_id"], name: "index_suppliers_on_order_repetition_setting_id", unique: true
  end
  ...
  create_table "webpush_notification_endpoints", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "url"
    t.string "p256dh_key"
    t.string "auth_key"
    t.integer "user_id"
    t.index ["auth_key"], name: "index_webpush_notification_endpoints_on_auth_key"
    t.index ["p256dh_key"], name: "index_webpush_notification_endpoints_on_p256dh_key"
    t.index ["url"], name: "index_webpush_notification_endpoints_on_url"
    t.index ["user_id"], name: "index_webpush_notification_endpoints_on_user_id"
  end
